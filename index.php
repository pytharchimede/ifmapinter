...
try {
  $pairs = [
    ...
    // Institut – compléments
    ['fr', 'page.institut.director.title', 'Mot du Directeur'],
    ['en', 'page.institut.director.title', 'Director Message'],
    ['fr', 'page.institut.director.badge.strategy', 'Stratégie'],
    ['en', 'page.institut.director.badge.strategy', 'Strategy'],
    ['fr', 'page.institut.director.badge.innovation', 'Innovation'],
    ['en', 'page.institut.director.badge.innovation', 'Innovation'],
    ['fr', 'page.institut.director.badge.impact', 'Impact'],
    ['en', 'page.institut.director.badge.impact', 'Impact'],
    // Contact – nouveau titre & CTA
    ['fr', 'page.contact.title.full', 'Contact & Accès'],
    ['en', 'page.contact.title.full', 'Contact & Access'],
    ['fr', 'page.contact.cta.title', "Besoin d'une présentation détaillée ?"],
    ['en', 'page.contact.cta.title', 'Need a detailed presentation?'],
    // Contact – supplémentaires
    ['fr', 'page.contact.hero.lead', 'Échange rapide, accompagnement personnalisé et informations pratiques.'],
    ['en', 'page.contact.hero.lead', 'Fast response, tailored guidance and practical information.'],
    ['fr', 'page.contact.form.title', "Écrire à l'équipe"],
    ['en', 'page.contact.form.title', 'Write to the team'],
    ['fr', 'page.contact.form.subtitle', 'Réponse sous 24h ouvrées.'],
    ['en', 'page.contact.form.subtitle', 'Reply within 24 business hours.'],
    ['fr', 'page.contact.form.name', 'Nom *'],
    ['en', 'page.contact.form.name', 'Name *'],
    ['fr', 'page.contact.form.email', 'Email'],
    ['en', 'page.contact.form.email', 'Email'],
    ['fr', 'page.contact.form.phone', 'Téléphone'],
    ['en', 'page.contact.form.phone', 'Phone'],
    ['fr', 'page.contact.form.subject', 'Objet'],
    ['en', 'page.contact.form.subject', 'Subject'],
    ['fr', 'page.contact.form.message', 'Message *'],
    ['en', 'page.contact.form.message', 'Message *'],
    ['fr', 'page.contact.channels.title', 'Canaux Directs'],
    ['en', 'page.contact.channels.title', 'Direct Channels'],
    ['fr', 'page.contact.channels.subtitle', 'Choisissez le canal le plus adapté à votre demande.'],
    ['en', 'page.contact.channels.subtitle', 'Choose the most suitable channel for your request.'],
    ['fr', 'page.contact.location.title', 'Localisation'],
    ['en', 'page.contact.location.title', 'Location'],
    ['fr', 'page.contact.location.hours', 'Ouvert Lun–Sam : 08h30–18h00'],
    ['en', 'page.contact.location.hours', 'Open Mon–Sat: 08:30–18:00'],
    ['fr', 'page.contact.faq.title', 'FAQ Express'],
    ['en', 'page.contact.faq.title', 'Quick FAQ'],
    ['fr', 'page.contact.faq.q1', "Comment s'inscrire à un programme ?"],
    ['en', 'page.contact.faq.q1', 'How to apply to a program?'],
    ['fr', 'page.contact.faq.a1', "Choisissez un programme puis remplissez le formulaire d'inscription. Un conseiller vous recontacte."],
    ['en', 'page.contact.faq.a1', 'Select a program then fill the application form. An advisor will contact you.'],
    ['fr', 'page.contact.faq.q2', 'Les formations sont-elles certifiantes ?'],
    ['en', 'page.contact.faq.q2', 'Are trainings certified?'],
    ['fr', 'page.contact.faq.a2', "Certaines aboutissent à des certifications; d'autres à des attestations professionnelles."],
    ['en', 'page.contact.faq.a2', 'Some lead to certifications; others to professional attestations.'],
    ['fr', 'page.contact.faq.q3', 'Peut-on devenir partenaire ?'],
    ['en', 'page.contact.faq.q3', 'Can we become a partner?'],
    ['fr', 'page.contact.faq.a3', 'Oui : stages, co‑construction de contenus, projets techniques, conférences métiers.'],
    ['en', 'page.contact.faq.a3', 'Yes: internships, co‑designed content, technical projects, professional talks.'],
    ['fr', 'page.contact.cta.subtitle', "Organisons une session découverte (visio ou présentiel) avec nos équipes pédagogiques."],
    ['en', 'page.contact.cta.subtitle', 'Let us schedule a discovery session (online or on-site) with our pedagogical team.'],
    ['fr', 'page.contact.cta.btn.institut', "Découvrir l'Institut"],
    ['en', 'page.contact.cta.btn.institut', 'Discover the Institute'],
    ['fr', 'page.contact.cta.btn.programmes', 'Programmes'],
    ['en', 'page.contact.cta.btn.programmes', 'Programs'],
    // Footer – i18n
    ['fr', 'footer.contact.title', 'Contact'],
    ['en', 'footer.contact.title', 'Contact'],
    ['fr', 'footer.links.title', 'Liens'],
    ['en', 'footer.links.title', 'Links'],
    ['fr', 'footer.follow.title', 'Suivez-nous'],
    ['en', 'footer.follow.title', 'Follow us'],
    ['fr', 'footer.newsletter.title', 'Newsletter'],
    ['en', 'footer.newsletter.title', 'Newsletter'],
    ['fr', 'footer.newsletter.text', 'Recevez nos dernières actualités et événements.'],
    ['en', 'footer.newsletter.text', 'Receive our latest news and events.'],
    ['fr', 'footer.address.label', 'Adresse'],
    ['en', 'footer.address.label', 'Address'],
    ['fr', 'footer.phone.label', 'Téléphone'],
    ['en', 'footer.phone.label', 'Phone'],
    ['fr', 'footer.email.label', 'Email'],
    ['en', 'footer.email.label', 'Email'],
    ['fr', 'footer.map.title', 'Accès & Carte'],
    ['en', 'footer.map.title', 'Access & Map'],
    ['fr', 'footer.map.btn', 'Voir la carte'],
    ['en', 'footer.map.btn', 'View Map'],
  ];
